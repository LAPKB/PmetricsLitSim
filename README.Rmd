...
You can also manually install `PmetricsLitSim` from [r-universe](https://lapkb.r-universe.dev/Pmetrics). To install, you must specify `r-universe` as the repository using
