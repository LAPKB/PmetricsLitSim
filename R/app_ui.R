      ...
      shiny::titlePanel(
        shiny::div(
          ...
          shiny::div(
            ...
            shiny::tags$small(
              style = "color: #6c757d; font-size: 12px; display: block; margin-top: 2px;",
      ...
      shiny::sidebarLayout(
        shiny::sidebarPanel(
          ...
          shiny::div(
            ...
            shiny::radioButtons( "param_mode", NULL, choices = c("Manual" = "manual", "Upload CSV" = "upload"), inline = TRUE, selected = "manual"),
            shiny::fluidRow(
              shiny::column(6, shiny::radioButtons("iiv_input_type", "IIV:", choices = c("CV%" = "cv", "omega^2" = "omega2"), inline = TRUE, selected = "cv")),
              shiny::column(6, shiny::radioButtons("rse_input_type", "Uncertainty:", choices = c("RSE%" = "rse", "SE" = "se"), inline = TRUE, selected = "rse"))
            ),
            ...
            shiny::conditionalPanel(
              ...
              shiny::fileInput( "param_file", NULL, accept = ".csv", placeholder = "Choose CSV file..."),
          ...
          shiny::div(
            ...
            shiny::radioButtons( "corr_mode", NULL, choices = c("Manual" = "manual", "Upload CSV" = "upload"), inline = TRUE, selected = "manual"),
            ...
            shiny::conditionalPanel(
              ...
              shiny::fileInput("corr_file", NULL, accept = ".csv", placeholder = "Choose CSV file..."),
          ...
          shiny::div(
            ...
            shiny::actionButton("simulate", "Simulate", icon = shiny::icon("play"), class = "btn-primary btn-lg", style = "width: 100%;")
          )
        ),
        ...
        shiny::mainPanel(
          ...
          shiny::tabsetPanel(
            ...
            shiny::tabPanel(
              title = "Bestdose Model",
              shiny::h5(shiny::HTML('Covariates equations <span style="color:#888; font-style:italic;"> (ex cl = cl0 * (weight/70)) </span>')),
              shiny::br(),
              shiny::textAreaInput("bestdose_model_code", NULL, placeholder = "Enter Pmetrics code for the literature model (one per line)", width = "100%", rows = 3),
              shiny::hr(),
              shiny::h5(shiny::HTML('ODE Code <span style="color:#888; font-style:italic;"> (ex: dx[1] = r[1] - cl0/v * X[1]) </span>')),
              shiny::br(),
              shiny::textAreaInput("bestdose_ode_code", NULL, placeholder = "Enter ODE code for the literature model (one per line)", width = "100%", rows = 3),
              shiny::hr(),
              shiny::h5(shiny::HTML('Output Equation <span style="color:#888; font-style:italic;"> (ex: Y[1] <- X[2] / v ) </span>')),
              shiny::br(),
              shiny::textAreaInput("bestdose_output_code", NULL, placeholder = "Enter output equation code for the literature model (one per line)", width = "100%", rows = 3)
            )
          )
        )
      )
